...
@section('title', 'Edit Product | E-commerce Shop')
...
@section('content')
    ...
    <form class="product" action="{{ route('product.update.data', $product->id) }}" method="post" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('title') is-invalid @enderror" id="title" name="title" type="text" value="{{ $product->title }}" required>
                                    @error('title')
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="subtitle" name="subtitle" type="text" value="{{ $product->subtitle }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select id="category_id" name="category_id" class="custom-select mb-3  @error('category_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($category as $val)
                                            <option value="{{ $val->id }}" @if ($val->id == $product->category_id) selected @endif>{{ $val->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('category_id')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control @error('price') is-invalid @enderror" type="text" id="price" name="price" placeholder="200" value="{{ $product->price }}" required>
                                        @error('price')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <select class="selectpicker form-control @error('attribute_id') is-invalid @enderror" id="attribute_id" name="attribute_id[]" multiple data-options='{"placeholder":"Select collections"}'>
                                        @foreach($attribute as $att)
                                            <option value="{{ $att->id }}"
                                                    ...
                                                    @if ($value->id == $att->id) selected @endif
                                                @endforeach
                                            >{{ $att->name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('solution3DID') is-invalid @enderror" id="solution3DID" name="solution3DID" value="{{ $product->solution3DID }}" type="text" placeholder="EX: 4200" required>
                                    @error('solution3DID')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('solution3DName') is-invalid @enderror" id="solution3DName" name="solution3DName" value="{{ $product->solution3DName }}" placeholder="EX: sofa" type="text" required>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('distID') is-invalid @enderror" id="distID" name="distID" type="text" value="{{ $product->distID }}" required placeholder="EX: 9906">
                                    @error('distID')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('projectName') is-invalid @enderror" id="projectName" name="projectName" type="text" value="{{ $product->projectName }}" placeholder="EX: l-shape-sofa" required>
                                    @error('projectName')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('script_code') is-invalid @enderror" id="script_code" name="script_code" type="text" value="{{ $product->script_code }}" placeholder="EX: https://distcdn.unlimited3d.com/pres/v/1.1.3/unlimited3d.min.js" required>
                                    @error('script_code')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="card-body bg-light">
                            ...
                            <div class="pl-2">
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" name="status" value="1" id="active" @if($product->status == 1) checked @endif />
                                    <label class="custom-control-label" for="active">Active</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" value="0" name="status" id="draft" @if($product->status == 0) checked @endif />
...
{{--                            <div class="pl-2">--}}
{{--                                <div class="fallback"><input id="fallback" type="file" onchange="showImage(this.files[0])" name="featured_image"></div>--}}
{{--                                <div class="preview">--}}
{{--                                    <div class="image-complete" id="image_complete"><img id="preview_img" class="my-preview-img" src="#">--}}
{{--                                        <a class="img-remove text-danger" onclick="imgRemove()" href="#!">--}}
{{--                                            <span class="fas fa-times"></span>--}}
{{--                                        </a>--}}
{{--                                        <div class="message-text" id="uploadImage">--}}
...
{{--                            </div>--}}
                            ...
                            <div class="pl-2">
                                ...
                                <div class="preview">
                                    <div class="image-complete" id="image_complete"  style="{{ $product->preview_image_id ? 'display: none;' : 'display: block;' }}">
                                        <div class="message-text" id="uploadImage" style="{{ $product->preview_image_id ? 'display: none;' : 'display: block;' }}">
                                            <img class="mr-2" src="{{ asset('assets/img/icons/cloud-upload.svg') }}" width="25" alt="">Drop your file here
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="pl-2 text-center" id="img_show">
                                <img id="preview_img" @if ($product->preview_image_id) src="{{ asset($product->photo->large) }}" @else src="#" @endif class="my-preview-img" style="{{ $product->preview_image_id ? 'display: block; border: 2px dashed' : 'display: none; border: none;' }}">
                                <a class="img-remove btn btn-danger btn-sm" id="{{ $product->preview_image_id }}" onclick="imgRemove(event)" href="#!" style="{{ $product->preview_image_id ? 'display: inline-block;' : 'display: none;' }}">
                                    Remove
                                </a>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="seo_slug" name="seo_slug" type="text" value="{{ $product->seo_slug }}">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="meta_keywords">Meta Keywords</label>
                                        <input class="form-control" data-role="tagsinput" id="meta_keywords" name="meta_keywords" placeholder="Enter Keywords"  value="{{ $product->meta_keywords }}" type="text">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
        ...
        function imgRemove(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    //Delete Request Send
                    axios.delete('/admin/product/image/delete/' + targetId)
                        .then(response => {
                            hideImage();
                            Swal.fire(
                                'Deleted!',
