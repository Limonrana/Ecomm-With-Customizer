            ...
            <div class="cart-product-wrapper">
                <div class="cart-product-container  ps-scroll">
                    ...
                    <div class="single-cart-product">
                        ...
                        <div class="image">
                            <a href="shop-product-basic.html">
                                <img src="{{ asset('frontend/images/cart-product-image/01.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="content">
                    ...
                    <div class="single-cart-product">
                        ...
                        <div class="image">
                            <a href="shop-product-basic.html">
                                <img src="{{ asset('frontend/images/cart-product-image/02.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="content">
                    ...
                    <div class="single-cart-product">
                        ...
                        <div class="image">
                            <a href="shop-product-basic.html">
                                <img src="{{ asset('frontend/images/cart-product-image/03.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="content">
...
<div id="qv-1" class="cd-quick-view">
    <div class="cd-slider-wrapper">
        <ul class="cd-slider">
            <li class="selected"><img src="{{ asset('frontend/images/arts-craft-one/Product-20.jpg') }}" alt="Product 2"></li>
            <li><img src="{{ asset('frontend/images/arts-craft-one/Product-21.jpg') }}" alt="Product 1"></li>
        </ul> <!-- cd-slider -->
