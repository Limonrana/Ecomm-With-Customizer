...
@section('title', 'Product | E-commerce Shop')
                                ...
                                <div class="overflow-hidden">
                                    <div class="position-relative rounded-top overflow-hidden">
                                        <a class="d-block" href="{{ route('product.show', $val->slug) }}">
                                            <img class="img-fluid rounded-top" src="{{ asset($val->preview_image_id ? $val->photo->small : 'uploads/default/no-image.png') }}"/>
                                        </a>
                                    ...
                                    <div class="p-3">
                                        ...
                                        <h5 class="fs-md-2 text-warning mb-0 d-flex align-items-center mb-3">${{ $val->price }}</h5>
...
{{--                                            </strong></p>--}}
                                ...
                                <div class="d-flex align-items-center justify-content-between px-3">
                                    <div class="text-right">
                                        ...
                                        <a class="btn btn-sm btn-falcon-default" href="{{ route('product.delete.data', $val->id) }}" id="delete" data-toggle="tooltip" data-placement="top" title="DELETE">
